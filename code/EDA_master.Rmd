...
for(i in 1:1) {
  ...
  for( k in 1:(84-(trainingSize + j) + 1))
  {
    ...
    model1_est = invisible(est.ar.wge(temp1$STD_Cases[k:(k+(trainingSize-1))],p=model1$p))
    ...
    assign(paste("AR_DF_",k,sep=""),trainingSize-(model1$p+1))
  ...
  results[i,paste0("AA_8_ASE")] = WindowedASE8
...
#ARIMA Model with q=0 and S=12
  ...
  Combined_Means <- data.frame(EqualMeans_Means,AR_Means, ARMA_Means, ARI_Means, ARIMA_Means, ARIS_Means, ARIMAS_Means)
  Combined_Means$horizon <- as.numeric(row.names(Combined_Means))
  
# more colors #59DBF1, #00C590, #73EBAE
