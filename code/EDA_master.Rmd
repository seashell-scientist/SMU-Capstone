...
# more colors #73EBAE
  g <- ggplot(data=Combined_Means, aes(horizon)) +
    ...
    geom_line(aes(y=ARI_Means, color="ARIMA, q=0, d=1"),size=1.5) +
    geom_line(aes(y=ARIMA_Means, color="ARIMA, d=1"),size=1.5) +
    geom_line(aes(y=ARIS_Means, color="ARIMA, q=0, s=12"),size=1.5) +
    geom_line(aes(y=ARIMAS_Means, color="ARIMA, s=12"),size=1.5) +
    ...
    scale_color_manual(values = c(
      ...
      'AR' = '#65A8C4',
      'ARMA' = '#8C65D3',
      'ARIMA, q=0, d=1' = '#9A93EC',
      'ARIMA, d=1' = '#0052A5',
      'ARIMA, q=0, s=12' = '#413BF7',
      'ARIMA, s=12' = '#00ADCE',
