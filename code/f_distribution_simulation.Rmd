...
for(j in 1:10000) {
  ...
  model1_est = invisible(est.arma.wge(x,p=model1$p,q=model1$q))
...
plot(d,xlim=xlim,ylim=ylim,main="F-Statistic Distribution for Equal Means/ARMA Residuals",xlab="")
curve(df(x,2,57),add=T,col='blue')
legend(4,1.5,legend=c("Equal Means/ARMA","F Distribution DF=2,57"),col=c("black","blue"),lty=1:1, cex=0.8)
```
